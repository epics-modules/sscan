...
*   Prefix length was inconsistently enforced, with the result that the maximum number of characters (excluding the trailing null) was actually eight, instead of nine.
